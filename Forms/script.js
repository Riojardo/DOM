...
function display_firstname ()
{
  ...
  let Fname_input = document.querySelector('input#firstname').value;
  document.querySelector('span#display-firstname').textContent = Fname_input;

}

let input_name = document.querySelector("input#firstname");
input_name.addEventListener('keyup',display_firstname)

display_firstname()


function display_truth ()
{
  let age_input = document.querySelector('input#age').value;
  let truth = document.querySelector('section#a-hard-truth')
  if (age_input >= 18) {
...
input_age.addEventListener('input',display_truth);
